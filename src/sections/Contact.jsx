        ...
        <div className="grid gap-6 md:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)]">
          <div className="space-y-5">
            <div className="flex items-start gap-4 rounded-2xl card p-5">
              <span className="flex h-12 w-12 items-center justify-center rounded-full bg-pink-900 text-pink-200">
                <FiMail size={22} />
              </span>
              <div>
                <h3 className="text-xs font-semibold uppercase tracking-[0.2em] text-slate-500 dark:text-slate-400">Email</h3>
                <a className="text-lg font-medium text-slate-100 underline-offset-4 hover:underline" href="mailto:yagneshjp1406@gmail.com">
            ...
            <div className="flex items-start gap-4 rounded-2xl card p-5">
              ...
              <div>
                ...
                <p className="text-lg font-medium text-slate-100">+91-7016178175</p>
              </div>
            </div>
            <div className="flex flex-wrap gap-3">
              {socials.map(({ label, href, icon: Icon }) => (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                    className="inline-flex w-full max-w-[10.5rem] items-center justify-center gap-2 rounded-full border border-slate-700 bg-slate-900 px-4 py-2 text-sm font-medium text-slate-200 shadow-sm transition-all hover:-translate-y-0.5 hover:border-teal-400 hover:text-teal-300"
                >
                  <Icon size={18} />
                  {label}
                </a>
